...
@{
    ...
    Defaults = @{
        ...
        # CUDA 13.4 + cuDNN 9.26 on C: (single-drive runners). These are the install paths
        # each woa-arm64 runner is expected to provide: CUDA at
        # C:\Program Files\NVIDIA\CUDA\v13.4 and cuDNN at
        # C:\Program Files\NVIDIA\CUDNN\v9.26 (folder names use v<major.minor>, not the patch).
        ...
        # (include has no arch subfolder). For CTK 13.4 arm64 that is ...\v9.26\lib\13.4\arm64 etc.
        CudnnRoot       = 'C:\Program Files\NVIDIA\CUDNN\v9.26'
        CudnnLibDir     = 'C:\Program Files\NVIDIA\CUDNN\v9.26\lib\13.4\arm64'
        CudnnIncludeDir = 'C:\Program Files\NVIDIA\CUDNN\v9.26\include\13.4'
        CudnnBinDir     = 'C:\Program Files\NVIDIA\CUDNN\v9.26\bin\13.4\arm64'
